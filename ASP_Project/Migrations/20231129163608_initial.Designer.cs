...
namespace ASP_Project.Migrations
{
    ...
    [Migration("20231129163608_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASP_Project.Areas.Identity.Data.Models.Favorite", b =>
                {
                    ...
                    b.HasKey("UserId", "SubProductVariationId");

                    b.HasIndex("SubProductVariationId");
            ...
            modelBuilder.Entity("ASP_Project.Areas.Identity.Data.Models.SubProductVariation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASP_Project.Areas.Identity.Data.Models.Favorite", b =>
                {
                    b.HasOne("ASP_Project.Areas.Identity.Data.Models.SubProductVariation", "SubProductVariation")
                        .WithMany("Favorites")
                        .HasForeignKey("SubProductVariationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("SubProductVariation");
            ...
            modelBuilder.Entity("ASP_Project.Areas.Identity.Data.Models.ProductImage", b =>
                {
                    ...
                    b.HasOne("ASP_Project.Areas.Identity.Data.Models.SubProductVariation", null)
                        .WithMany("ProductImages")
                        .HasForeignKey("SubProductVariationId");
            ...
            modelBuilder.Entity("ASP_Project.Areas.Identity.Data.Models.ShoppingCartItem", b =>
                {
                    ...
                    b.HasOne("ASP_Project.Areas.Identity.Data.Models.SubProductVariation", "SubProductVariation")
                        ...
                        .HasForeignKey("ASP_Project.Areas.Identity.Data.Models.ShoppingCartItem", "SubProductVariationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
